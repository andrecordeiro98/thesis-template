...
\pdfminorversion=7						% Allows output to be PDF version 1.7

%ThE LooOks!
\usepackage{emptypage}					% No numbering on empty pages
\usepackage{fancyhdr}					% Fancy Headers
\usepackage{geometry}					% Control geometry
%\usepackage[showframe]{geometry}		% Control geometry (show the page frame)
\usepackage{setspace}
\usepackage[bottom,para]{footmisc}      %Send footnotes to the bottom of the page
...
% Useful Tools
\usepackage[auto-lang=false]{lipsum}	% Create random text
...
% -------------------------
% Makes sure there are no headers, according to regulation
\pagestyle{plain}
\fancyfoot[C]{\thepage}
...
\renewcommand{\footnotelayout}{\setstretch{1}} % For footnotes, this should be one line
\setstretch{1.5} % Main text, we should have 1.5 lines of spacing
%--------------------------
% All blank space is sent to the bottom of the page
\raggedbottom

%--------------------------
% Controls footnote size:
%\renewcommand{\footnotesize}{\fontsize{10pt}{10pt}}
...
\def\FontLn{% 16 pt normal
	\usefont{T1}{\fontnamestring}{m}{n}\fontsize{18pt}{20pt}\selectfont}
\def\FontLb{% 16 pt bold
	\usefont{T1}{\fontnamestring}{b}{n}\fontsize{18pt}{20pt}\selectfont}
\def\FontMn{% 14 pt normal
	\usefont{T1}{\fontnamestring}{m}{n}\fontsize{14pt}{15pt}\selectfont}
\def\FontMb{% 14 pt bold
	\usefont{T1}{\fontnamestring}{b}{n}\fontsize{14pt}{15pt}\selectfont}
\def\FontSn{% 12 pt normal
	\usefont{T1}{\fontnamestring}{m}{n}\fontsize{11pt}{11pt}\selectfont}
\def\FontSb{% 12 pt normal
	\usefont{T1}{\fontnamestring}{b}{n}\fontsize{11pt}{11pt}\selectfont}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% These were meant for the MSc cover

\def\FontLnMSc{% 16 pt normal
	\usefont{T1}{\fontnamestring}{m}{n}\fontsize{16pt}{16pt}\selectfont}
\def\FontLbMSc{% 16 pt bold
	\usefont{T1}{\fontnamestring}{b}{n}\fontsize{16pt}{16pt}\selectfont}
\def\FontMnMSc{% 14 pt normal
	\usefont{T1}{\fontnamestring}{m}{n}\fontsize{14pt}{14pt}\selectfont}
\def\FontMbMSc{% 14 pt bold
	\usefont{T1}{\fontnamestring}{b}{n}\fontsize{14pt}{14pt}\selectfont}
\def\FontSnMSc{% 12 pt normal
	\usefont{T1}{\fontnamestring}{m}{n}\fontsize{12pt}{12pt}\selectfont}
\def\FontSbMsc{% 12 pt normal
	\usefont{T1}{\fontnamestring}{b}{n}\fontsize{12pt}{12pt}\selectfont}
...
%--------------------------
% Math typset inside bold text is automatically bold
...
\newcommand{\thesistitlePT}{[Título da Tese]}
\newcommand{\thesistitleEN}{[Thesis Title]}

\newcommand{\authorname     }{[Author's Full Name]}

\newcommand{\supervisortitle  }{\textbf{Orientador(a)} \textit{(Supervisor)}}
\newcommand{\cosupervisortitle}{\textbf{Coorientadores} \textit{(Co-supervisors)}}

\newcommand{\supervisor     }{\textbf{Doutor(a)} \textit{(Doctor)} [Supervisor's Full Name]}
\newcommand{\cosupervisorA  }{\textbf{Doutor(a)} \textit{(Doctor)} [Co-supervisor's Full Name]}
\newcommand{\cosupervisorB  }{\textbf{Doutor(a)} \textit{(Doctor)} [Co-supervisor's Full Name]}

\newcommand{\descriptionThesisDraftPT}{Tese especialmente elaborada para obtenção do Grau de Doutor em}
\newcommand{\descriptionThesisDraftEN}{Thesis specifically prepared to obtain the PhD Degree in}

\newcommand{\descriptionThesisPT}{Tese aprovada em provas públicas para obtenção do Grau de Doutor em}
\newcommand{\descriptionThesisEN}{Thesis approved in public session to obtain the PhD Degree in}

\newcommand{\scientificfieldPT}{(Ramo do conhecimento)}
\newcommand{\scientificfieldEN}{(Scientific area)}

\newcommand{\MonthYearPT}{[Mês e Ano]}
\newcommand{\MonthYearEN}{[Month and Year]}
