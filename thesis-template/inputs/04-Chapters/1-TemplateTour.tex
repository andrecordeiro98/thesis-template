...
\begin{itemize}
\item \texttt{/01-Cover-Page} -- Covers according to \textit{IST} regulations. The names of the author, supervisors, and committee members must be added, as well as the name of the degree. You can also choose a cover image. The commands in the main text must be edited with the names of the author, supervisors, the thesis title, etc. Available:
\begin{itemize}
