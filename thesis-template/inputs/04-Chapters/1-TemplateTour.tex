...
\begin{itemize}
\item \texttt{/01-Cover-Page} -- A cover according to \textit{IST} regulations. The names of the author, supervisors, and committee members must be added, as well as the name of the degree. You can also choose a cover image. When announcing the name of the degree, user must choose between \verb|\coverThesisMSc| and \verb|\coverThesisPhD|.
