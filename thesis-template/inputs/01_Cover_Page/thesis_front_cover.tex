...
%IST Logo
\includegraphics[viewport = 9.5cm 11cm 0cm 0cm ,scale = 0.29]{thesis-template/inputs/01_Cover_Page/IST_A_CMYK_POS}
...
\vspace{.05\textheight}
\begin{center}
\includegraphics[height=.15\textheight]{thesis-template/inputs/01_Cover_Page/solomon}
\end{center}
